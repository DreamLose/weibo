...
class PoperAnimator: NSObject {
    ...
    init(callbackStat : @escaping((_ presented : Bool) -> ())) {
       
        self.callBack = callbackStat
    }
}
...
extension PoperAnimator : UIViewControllerTransitioningDelegate {
    ...
    func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        let presentation = PresentationContrller(presentedViewController: presented, presenting: presenting)
